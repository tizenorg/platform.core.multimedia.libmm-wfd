...
#if 0
	/* create DRM bridge */
	MMWFDSINK_CREATE_ELEMENT (audiobin, WFD_SINK_A_HDCP, wfd_sink->ini.name_of_audio_hdcp, "audio_drm", link_audio_dec);
	MMWFDSINK_PAD_PROBE( wfd_sink, NULL, audiobin[WFD_SINK_A_HDCP].gst,  "sink" );
	MMWFDSINK_PAD_PROBE( wfd_sink, NULL, audiobin[WFD_SINK_A_HDCP].gst,  "src" );
#endif
	if (!link_audio_dec)
	{
...
#if 0
	/* create DRM bridge */
	MMWFDSINK_CREATE_ELEMENT (videobin, WFD_SINK_V_HDCP, wfd_sink->ini.name_of_video_hdcp, "video_drm", TRUE);
	MMWFDSINK_PAD_PROBE( wfd_sink, NULL, videobin[WFD_SINK_V_HDCP].gst,  "sink" );
	MMWFDSINK_PAD_PROBE( wfd_sink, NULL, videobin[WFD_SINK_V_HDCP].gst,  "src" );
#endif
	/* create parser */
